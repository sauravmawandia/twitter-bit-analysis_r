...
logit_twitter <- glm(bot ~  friends_count+ followers_count + statusPerDay + verified + favourites_count + name + screen_name + description,
...
test_set$botP <- predict(logit_twitter, newdata = test_set, interval = "prediction")
